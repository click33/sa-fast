...
// sa-fast 快速开发平台:		http://sa-fast.dev33.cn
// ....
...
sa.ajax('/AccAdmin/fristOpenAdmin', function(res) {
	...
	sa_admin.setMenuList(myMenuList, res.data.per_list);    // 初始化菜单   
...
sa_admin.dropList = [		// 头像点击处可操作的选项
	{
		name: '我的资料',
		click: function() {
			sa.showIframe('我的资料', 'sa-html-sf/sf-admin/admin-info.html', '700px', '600px');
		}
	},
    {
        name: '修改名称',
	...
	},
    {
        name: '修改密码',
        click: function () {
			sa.showIframe('修改密码', 'sa-html-sf/sf-admin/update-password.html', '550px', '400px');
        }
	},
    {
        name: '切换账号',
